<?php
    ...
    $pdf->Cell(0, 5, "Laporan Transaksi Barang Masuk : ".$tgl[0].' sampai '.$tgl[1], 0, 1, 'C');
    ...
    $pdf->Cell(25,6,'Supplier',1,0,'C',0);
    ...
    while ($query_data = mysql_fetch_array($rs2)) {
        ...
        $pdf->Cell(25,6,$query_data["supplier"],1,0,'C',1);
    ...
    //output file PDF
    $pdf->Output('TransaksiIn.pdf', 'I'); //download file pdf
?>