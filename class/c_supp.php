...
class c_supp
{
	...
	function addsupp(&$params) 
	{
		...
		$nbank = secureParam($params["txtbank"],$dbLink);
		...
		try
		{
			...
			$qq = "INSERT INTO `aki_supplier`(`id`, `supplier`, `alamat`, `kontak`, `nomor`, `norek`, `nrek`, `user`) VALUES ";
			$qq.= "('".$nopo."','".$supp."','".$alamat."','".$nameb."','".$hp."','".$norek."','".$nbank."','".$pembuat."');";
